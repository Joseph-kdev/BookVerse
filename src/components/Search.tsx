...
export default function Search() {
  ...
  return (
    <section className='bg-light-background dark:bg-dark-background min-h-screen'>
      <Nav />
      <div className="bg-white flex px-1 py-1 rounded-full border border-light-secondary dark:border-dark-secondary overflow-hidden max-w-md mx-auto font-[sans-serif] mt-2">
