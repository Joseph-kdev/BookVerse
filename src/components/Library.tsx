      ...
      <div>
        ...
        <div className="mt-2 mx-2">
          <select
            ...
            className="h-9 px-2 border border-light-secondary dark:border-dark-secondary rounded-full bg-light-primary dark:bg-dark-primary text-light-background dark:text-dark-background"
          >
